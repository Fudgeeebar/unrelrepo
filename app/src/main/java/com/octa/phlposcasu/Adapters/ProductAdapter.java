...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.CardHolder> {
    ...
    public ProductAdapter(Context context, List<ProductModel> productList, String categoryId, TextView productName, ImageView productImage,
                          ...
                          RelativeLayout addToCartBtn, View cartView, String key, String adminID, DatabaseReference databaseReference)
    {
...
//                    .error(mDefaultBackground)
                    ...
                    new AsyncTaskOptionsParent(context, categoryId, model, firebaseFirestore,
                            productView, optionsParentRecycler, addToCartBtn, cartView, key, adminID, databaseReference).execute();
                }
            });
        }
    }
